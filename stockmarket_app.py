...
def load_data():
    ...
    # NOTE: For Streamlit Cloud deployment, having 'sp500.csv' in the
    # repository is recommended for faster initial load, but this function
    # will re-fetch if the file is missing or out-of-date is implemented.
    # We'll stick to direct yfinance fetching for simplicity in this single script example.
...
@st.cache_data
def get_backtest_results(data, model, predictors):
